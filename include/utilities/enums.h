...
namespace ORNL
{
     ...
     */
    enum class BuildVolumeType : uint8_t {
        kRectangular = 0,
        kCylindrical = 1,
        kToroidal = 2
    };
    ...
    inline ThemeName themeFromString(QString theme) {
        if (theme == Constants::UI::Themes::kLightMode)
        {
            return ThemeName::kLightMode;
        }
        else if (theme == Constants::UI::Themes::kDarkMode)
        {
            return ThemeName::kDarkMode;
        }
    }
    ...
    enum class LayerChange : uint8_t
    {
        kZ_only = 0,
        kW_only = 1,
        kBoth_Z_and_W = 2
    ...
    enum class SeamSelection : uint8_t
    {
        kRandom,
        kOptimized,
        kRotating
    ...
    enum class PrintDirection : uint8_t
    {
        kReverse_off,
        kReverse_All_Layers,
        kReverse_Alternating_Layers
    };

    enum class ForceMinimumLayerTime : uint8_t
    {
        kUse_Purge_Dwells,
        kSlow_Feedrate
    };

    enum class PreferenceChoice : uint8_t
    {
        kAsk = 0,
        kPerformAutomatically = 1,
        kSkipAutomatically = 2
    };
    ...
    inline QString VisualizationColorsName(VisualizationColors color) {
        switch (color){
            ...
            case VisualizationColors::kRampingDown: return "RampingDown";
            case VisualizationColors::kRampingUp: return "RampingUp";
            case VisualizationColors::kSkeleton: return "Skeleton";
            case VisualizationColors::kSkin: return "Skin";
            case VisualizationColors::kSkirt: return "Skirt";
            case VisualizationColors::kSlowDown: return "SlowDown";
            case VisualizationColors::kSpiralLift: return "SpiralLift";
            case VisualizationColors::kSupport: return "Support";
            case VisualizationColors::kSupportRoof: return "SupportRoof";
            case VisualizationColors::kThermalScan: return "ThermalScan";
            case VisualizationColors::kTipWipeAngled: return "TipWipeAngled";
            case VisualizationColors::kTipWipeForward: return "TipWipeForward";
            case VisualizationColors::kTipWipeReverse: return "TipWipeReverse";
            case VisualizationColors::kTravel: return "Travel";


            case VisualizationColors::kUnknown:
            case VisualizationColors::Length: return "Unknown";

            default:
            QMessageBox::critical(Q_NULLPTR, "ORNL Slicer 2",
    ...
    inline constexpr const QColor VisualizationColorsDefaults(VisualizationColors color) {
        ...
        case VisualizationColors::kBrim: return QColor(200,113,55, 255);
            ...
            case VisualizationColors::kRampingDown: return QColor(22,99,137, 255);
            case VisualizationColors::kRampingUp: return QColor(99,22,137, 255);
            case VisualizationColors::kSkeleton: return QColor(160,44,44, 255);
            case VisualizationColors::kSkin: return QColor(0,128,0, 255);
            case VisualizationColors::kSkirt: return QColor(211,188,95, 255);
            case VisualizationColors::kSlowDown: return QColor(44,160,137, 255);
            case VisualizationColors::kSpiralLift: return QColor(113,55,200, 255);
            case VisualizationColors::kSupport: return QColor(255,102,0, 255);
            case VisualizationColors::kSupportRoof: return QColor(255,179,128, 255);
            case VisualizationColors::kThermalScan: return QColor(240,130,130, 255);
            case VisualizationColors::kTipWipeAngled: return QColor(179,128,255, 255);
            case VisualizationColors::kTipWipeForward: return QColor(179,128,255, 255);
            case VisualizationColors::kTipWipeReverse: return QColor(179,128,255, 255);
            case VisualizationColors::kTravel: return QColor(233,175,198, 255);


            case VisualizationColors::kUnknown:
            case VisualizationColors::Length: return QColor(0,0,0, 255);
    ...
    enum class TravelLiftType : uint8_t
    {
        kBoth = 0,
        kLiftUpOnly = 1,
        kLiftLowerOnly = 2,
    ...
    inline constexpr TravelLiftType operator|(const TravelLiftType& lhs,
                                          const TravelLiftType& rhs)
    {
        return static_cast< TravelLiftType >(static_cast< int >(lhs) |
                                         static_cast< int >(rhs));
    }
    ...
    enum class LayerOrdering : uint8_t
    {
        kByHeight = 0,
        kByLayerNumber = 1,
        kByPart = 2
    ...
    enum class NozzleAssignmentMethod : uint8_t
    {
        kXLocation = 0,
        kYLocation = 1,
        kArea = 2
    ...
    enum class PolygonPartition : uint8_t
    {
        kConvex = 0,
        kMonoX = 1,
        kMonoY = 2
