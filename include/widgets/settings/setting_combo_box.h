#ifndef SETTING_COMBO_BOX_H
#define SETTING_COMBO_BOX_H
...
namespace ORNL
{
    ...
    class SettingComboBox : public QComboBox, public SettingRowBase {
        ...
        public:
            ...
            SettingComboBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
