#ifndef SETTING_DENSITY_SPIN_BOX_H
#define SETTING_DENSITY_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingDensitySpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingDensitySpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_DENSITY_SPIN_BOX_H
