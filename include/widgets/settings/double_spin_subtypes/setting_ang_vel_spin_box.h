#ifndef SETTING_ANG_VEL_SPIN_BOX_H
#define SETTING_ANG_VEL_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingAngVelSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingAngVelSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_ANG_VEL_SPIN_BOX_H
