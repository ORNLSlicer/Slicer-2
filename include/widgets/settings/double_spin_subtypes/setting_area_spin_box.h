#ifndef SETTING_AREA_SPIN_BOX_H
#define SETTING_AREA_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingAreaSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingAreaSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
