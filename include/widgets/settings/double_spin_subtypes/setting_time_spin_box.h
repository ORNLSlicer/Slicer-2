#ifndef SETTING_TIME_SPIN_BOX_H
#define SETTING_TIME_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingTimeSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingTimeSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
