#ifndef SETTING_SPEED_SPIN_BOX_H
#define SETTING_SPEED_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingSpeedSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingSpeedSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_SPEED_SPIN_BOX_H
