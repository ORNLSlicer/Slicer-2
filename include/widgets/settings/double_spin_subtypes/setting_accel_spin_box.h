#ifndef SETTING_ACCEL_SPIN_BOX_H
#define SETTING_ACCEL_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingAccelSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingAccelSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_ACCEL_SPIN_BOX_H
