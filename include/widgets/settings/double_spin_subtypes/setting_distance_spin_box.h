#ifndef SETTING_DISTANCE_SPIN_BOX_H
#define SETTING_DISTANCE_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingDistanceSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingDistanceSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_DISTANCE_SPIN_BOX_H
