#ifndef SETTING_VOLTAGE_SPIN_BOX_H
#define SETTING_VOLTAGE_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingVoltageSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingVoltageSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_VOLTAGE_SPIN_BOX_H
