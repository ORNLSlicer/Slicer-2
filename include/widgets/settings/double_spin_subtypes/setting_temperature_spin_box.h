#ifndef SETTING_TEMPERATURE_SPIN_BOX_H
#define SETTING_TEMPERATURE_SPIN_BOX_H
...
namespace ORNL
{
    ...
    class SettingTemperatureSpinBox : public SettingDoubleSpinBox {
        ...
        public:
            ...
            SettingTemperatureSpinBox(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_TEMPERATURE_SPIN_BOX_H
