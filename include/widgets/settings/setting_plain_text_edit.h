#ifndef SETTING_PLAIN_TEXT_EDIT_H
#define SETTING_PLAIN_TEXT_EDIT_H
...
namespace ORNL
{
    ...
    class SettingPlainTextEdit :  public QPlainTextEdit, public SettingRowBase {
        ...
        public:
            ...
            SettingPlainTextEdit(SettingTab* parent, QSharedPointer<SettingsBase> sb, QString key, fifojson json, QGridLayout* layout, int index);
...
#endif // SETTING_PLAIN_TEXT_EDIT_H
