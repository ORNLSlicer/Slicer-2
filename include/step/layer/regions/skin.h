...
namespace ORNL {
    class Skin : public RegionBase {
        public:
            ...
            Skin(const QSharedPointer<SettingsBase>& sb, const int index, const QVector<SettingsPolygon>& settings_polygons, const SingleExternalGridInfo& gridInfo);
            ...
            //! \brief Computes the paths for the skin region.
            void createPaths();
        ...
        private:
            ...
            QVector<Path> optimizeHelper(QSharedPointer<PathOrderOptimizer> poo, bool supportsG3, QVector<Path>& innerMostClosedContour, Point& current_location,
                                InfillPatterns pattern, QVector<Path> paths, PolygonList geometry);
