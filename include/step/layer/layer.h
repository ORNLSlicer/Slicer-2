...
namespace ORNL {
    ...
    class Layer : public Step {
        public:
            ...
            //! \param previousRegions: chain of previously visited regions to allow decisions on inter-island and inter-layer transitions
            ...
            void calculateModifiers(Point& currentLocation);
        ...
        private:
            ...
            QList<QHash<QSharedPointer<IslandBase>, QList<QSharedPointer<IslandBase>>>> createSequence(QList<QSharedPointer<IslandBase>> parent, QList<QList<QSharedPointer<IslandBase>>> children);
