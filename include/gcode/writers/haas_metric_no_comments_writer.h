#ifndef HAAS_METRIC_NO_COMMENTS_WRITER_H
#define HAAS_METRIC_NO_COMMENTS_WRITER_H

//! \file haas_metric_no_comments_writer.h
...
#endif // HAAS_METRIC_NO_COMMENTS_WRITER_H
