#ifndef HYBRID_SLICER_H
#define HYBRID_SLICER_H
...
namespace ORNL {
    /*!
     * \class HybridSlicer
     * \brief Implementation of SlicingThread for hybrid slices.
     */
    class HybridSlicer : public TraditionalAST {
        public:
            HybridSlicer(QString gcodeLocation);
        ...
        private:
            ...
            void processRaft(QSharedPointer<Part> part, QSharedPointer<SettingsBase> part_sb);
