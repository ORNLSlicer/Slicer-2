...
namespace ORNL
{
    ...
    QString GudelWriter::writeInitialSetup(Distance minimum_x, Distance minimum_y, Distance maximum_x, Distance maximum_y, int num_layers)
    {
    ...
    QString GudelWriter::writeLine(const Point& start_point, const Point& target_point, const QSharedPointer<SettingsBase> params)
    {
    ...
    QString GudelWriter::writeArc(const Point &start_point,
    ...
    QString GudelWriter::writeShutdown()
    {
        ...
        rv += m_sb->setting< QString >(Constants::PrinterSettings::GCode::kEndCode) % m_newline %
              "M84" % commentSpaceLine("END OF G-CODE");
        return rv;
    }
