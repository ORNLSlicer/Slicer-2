...
namespace ORNL
{
    ...
    QString RomiFanucWriter::writeInitialSetup(Distance minimum_x, Distance minimum_y, Distance maximum_x, Distance maximum_y, int num_layers)
    {
    ...
    QString RomiFanucWriter::writeLine(const Point& start_point, const Point& target_point, const QSharedPointer<SettingsBase> params)
    {
    ...
    QString RomiFanucWriter::writeArc(const Point &start_point,
