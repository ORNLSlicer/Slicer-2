...
namespace ORNL
{
    ...
    QString HurcoWriter::writeInitialSetup(Distance minimum_x, Distance minimum_y, Distance maximum_x, Distance maximum_y, int num_layers)
    {
    ...
    QString HurcoWriter::writeLine(const Point& start_point, const Point& target_point, const QSharedPointer<SettingsBase> params)
    {
    ...
    QString HurcoWriter::writeArc(const Point &start_point,
